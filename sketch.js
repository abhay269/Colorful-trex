...
function preload(){
  ...
  //loading animation, images and sounds
  jumpSound = loadSound("assets/sounds/jump.wav");
  collidedSound = loadSound("assets/sounds/collided.wav");
  checkPointSound = loadSound("assets/sounds/CheckpointSound.mp3");
...
function setup() {
  ...
  //creating sprite, adding animation and images, scaling, setting collider and making it for any device to play
...
function draw() {
  ...
  //showing text, filling and setting size of text
  textSize(20);
  fill("black")
  ...
  //giving condition when game state is end
    ...
    if(touches.length>0 || mousePressedOver(restart) || keyDown("enter")) { 
...
//creating spawn clouds function
function spawnClouds() {
  
  //giving condition when frame count is / by 60 and remainder is 0
  if (frameCount % 60 === 0) {
...
//creating spawn obstacle function
